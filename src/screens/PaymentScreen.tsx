              ...
              <View style={styles.CreditCardBG}>
                <LinearGradient
                  ...
                  <View style={styles.CreditCardNumberContainer}>
                    ...
                    <Text style={styles.CreditCardNumber}>5897</Text>
                    <Text style={styles.CreditCardNumber}>2371</Text>
                    <Text style={styles.CreditCardNumber}>4433</Text>
                  </View>
                  <View style={styles.CreditCardRow}>
                    ...
                    <View style={styles.CreditCardDateContainer}>
                      ...
                      <Text style={styles.CreditCardNameTitle}>12/28</Text>
                    </View>
                  </View>
                </LinearGradient>
              </View>
